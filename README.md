...
基于 React + Vite 的 AE 与 Blender 视效制作知识库。当前包含 106 条记录，支持检索、平台与分类筛选、多图案例详情和原图放大，并附带 RGBA 通道合并工具。
...
扩展工具“RGBA 合并”在浏览器本地读取四个通道贴图，按亮度写入 R/G/B/A，支持透明棋盘预览、自定义 PNG 文件名和下载。
